...
import { IconBrandLinkedin, IconBrandUpwork, IconBrandX } from "@tabler/icons-react"
              ...
              <CardContent className="p-0">
                ...
                <div className="py-6 text-left">
                  ...
                  <div className="flex space-x-4 mt-4">
                    <a href={member.socials.upwork} target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300">
                      <IconBrandUpwork className="h-5 w-5" />
                    </a>
                    <a href={member.socials.twitter} target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300">
                      <IconBrandX className="h-5 w-5" />
                    </a>
                    <a href={member.socials.linkedin} target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300">
